...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'), 'I want an appointement ')

WebUI.rightClick(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'), 'I want an appointment  for my stomarchac')

WebUI.rightClick(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'), 'I want an appointment  for my stomachache')
